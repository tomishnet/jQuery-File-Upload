...
class UploadHandler
{
    ...
    protected function gd_get_image_object($file_path,
        $func,
        $no_cache = false)
    {
    ...
    protected function gd_set_image_object($file_path,
        $image)
    {
        $this->gd_destroy_image_object($file_path);
    ...
    protected function gd_imageflip($image,
        $mode)
    {
    ...
    protected function imagick_set_image_object($file_path,
        $image)
    {
        $this->imagick_destroy_image_object($file_path);
        $this->image_objects[$file_path] = $image;
    ...
    protected function handle_image_file($file_path,
        $file)
    {
    ...
    protected function handle_form_data($file,
        $index)
    {
